...
def parse(url):
     ...
     film_rate = soup.find_all('span', class_='p-rate-flag__text') and soup.find_all('span', class_='p-rate-flag__imdb-text')
     film_names_list = []
     film_info_list = []
     film_rate_list = []
...
#----------------------------------------------------------------------------------------------------------------
     ...
     dframe_names.to_csv('film_list_by_pandas.csv', encoding='utf-8', mode='a')
